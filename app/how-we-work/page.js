...
export const metadata = {
  title: "How We Work | Brno Web",
  description:
    "Discover Brno Web’s step-by-step process — from strategy and design to development, testing, and launch. Transparent, efficient, and results-driven.",
  openGraph: {
    title: "How We Work | Brno Web",
    description:
      "Learn about our structured process that combines strategy, creativity, and technology to bring your ideas to life.",
    url: "https://www.brnoweb.com/how-we-work",
    siteName: "Brno Web",
    images: [
      {
        url: "https://www.brnoweb.com/howwework.webp",
        width: 1200,
        height: 630,
        alt: "How We Work - Brno Web",
      },
    ],
    type: "article",
  },
  ...
  return (
    <main className="w-full py-20 relative  bg-stone-100 ">
      <div className="w-[65%] max-lg:w-[80%] max-md:w-[90%]  mx-auto p-6 shadow-2xl rounded-4xl overflow-hidden service-shadow border-stone-300 border">
        ...
        />
        <h4 className="how-title-mini mt-7">Work Steps</h4>
        <h2 className="how-section-title">How We Work</h2>
        <p className="how-section-abstract mt-3">
          Our structured approach combines strategy, creativity, and technology
          to deliver results that make an impact. Here's how we bring your ideas
          to life:
        </p>
